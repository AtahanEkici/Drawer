...
public class ErrorSystem : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI ErrorBaşlık;
    ...
    private void GetReferences()
    {
        ...
        if (ErrorBaşlık == null)
        {
            ErrorBaşlık = transform.GetChild(0).GetComponent<TextMeshProUGUI>();
        }
        ...
        if(TimerSlider == null)
        {
            TimerSlider = ErrorBaşlık.transform.GetChild(0).GetComponent<Slider>();
    ...
    public void SetErrorMessage(string Message, string Başlık)
    {
        ErrorMessage.text = Message;
        ErrorBaşlık.text = Başlık;
        ErrorReceived = true;
    }
